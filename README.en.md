...
This repository is a personal customized version of [Mizuki](https://github.com/LyraVoid/Mizuki), which is licensed under the Apache License 2.0.

Mizuki is based on [Fuwari](https://github.com/saicaca/fuwari), which is licensed under the MIT License. The original license files are retained in this repository as [LICENSE](./LICENSE) and [LICENSE.MIT](./LICENSE.MIT).

This customized version includes Chinese localization, layout adjustments, feature removals, navigation behavior changes, and personal blog configuration changes. This repository is not an official Mizuki project and is not endorsed by the original authors.
...
🌏 **README Languages:**
[**English**](./README.en.md) / [**中文**](./README.md) / [**日本語**](./README.ja.md) / [**繁體中文**](./README.tw.md) /
