...
本倉庫是基於 [Mizuki](https://github.com/LyraVoid/Mizuki) 的個人客製版本，原專案使用 Apache License 2.0。

Mizuki 基於 [Fuwari](https://github.com/saicaca/fuwari) 開發，Fuwari 使用 MIT License。原始授權文件已保留在本倉庫的 [LICENSE](./LICENSE) 和 [LICENSE.MIT](./LICENSE.MIT) 中。

本客製版本包含中文化、版面調整、功能裁剪、導覽行為修改和個人部落格設定調整。本倉庫不是 Mizuki 官方專案，也不代表原作者認可本版本。
