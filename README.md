...
本仓库是基于 [Mizuki](https://github.com/LyraVoid/Mizuki) 的个人定制版本，原项目使用 Apache License 2.0。

Mizuki 基于 [Fuwari](https://github.com/saicaca/fuwari) 开发，Fuwari 使用 MIT License。原始许可文件已保留在本仓库的 [LICENSE](./LICENSE) 和 [LICENSE.MIT](./LICENSE.MIT) 中。

本定制版本包含中文化、布局调整、功能裁剪、导航行为修改和个人博客配置调整。本仓库不是 Mizuki 官方项目，也不代表原作者认可本版本。
